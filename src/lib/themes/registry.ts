...
export const THEME_REGISTRY: readonly ThemeDefinition[] = [
  {
    id: "minimal",
    name: "Minimal",
    description: "Quiet light surface, hairline borders, system type.",
    colorScheme: "light",
    tokens: {
  ...
  },
  {
    id: "modern",
    name: "Modern",
    description: "Cool light canvas with a clear primary accent.",
    colorScheme: "light",
    tokens: {
  ...
  },
  {
    id: "professional",
    name: "Professional",
    description: "Navy-leaning light theme for résumé-style sites.",
    colorScheme: "light",
    tokens: {
  ...
  },
  {
    id: "developer",
    name: "Developer",
    description: "Dark charcoal surface — matches the original seed palette.",
    colorScheme: "dark",
    tokens: {
